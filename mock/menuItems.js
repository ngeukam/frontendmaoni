...
import { FaBaby, FaBlog, FaHamburger, FaRedhat, FaUsers } from "react-icons/fa";
...
export const extraMenu = [
  { title: "forConsumers", icon: FaUsers, href: "/" },
  { title: "allCategories", icon: FaHamburger, href: "/categories" },
  { title: "blog", icon: FaBlog, href: "/blank" },
  { title: "connection", icon: HiOutlineLogin, href: "/businessSpace/login" },
];