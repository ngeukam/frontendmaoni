...
import { wordsToPascalCase } from "../../utilities/camel";
                ...
                <Link href={breadcrumb.href}>
                  <a className="inline-block px-2">
                    {t[convertBreadcrumb(breadcrumb.breadcrumb)]
                      ? t[convertBreadcrumb(breadcrumb.breadcrumb)]
                      : t[wordsToPascalCase(convertBreadcrumb(breadcrumb.breadcrumb))] || decodeURIComponent(convertBreadcrumb(breadcrumb.breadcrumb))}
                  </a>
                </Link>
              </li>
            );
